...
class PrintersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post printers_url, params: { printer: { conect: @printer.conect, labelled: @printer.labelled, mark: @printer.mark } }
    end
  ...
  test "should update printer" do
    patch printer_url(@printer), params: { printer: { conect: @printer.conect, labelled: @printer.labelled, mark: @printer.mark } }
